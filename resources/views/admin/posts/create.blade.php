                    ...
                    <form class="m-form m-form--fit m-form--label-align-right" method="post"
                        ...
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <textarea class="form-control m-input" id="description" name="description" rows="10">{{old('description')}}</textarea>
                            </div>
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <input type="text" class="form-control m-input" name="keywords"
                                       placeholder="Keywords được phân cách bởi dấu phẩy" value="{{old('keywords')}}">
                            </div>
                        </div>
