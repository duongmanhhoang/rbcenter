                        ...
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group row">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control my-datepicker" name="start_day" readonly="" value="{{old('start_day')}}"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control my-datepicker" name="end_day" readonly="" value="{{old('end_day')}}"
